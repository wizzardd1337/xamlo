_1IOII01IlO0Ol001 = __import__('hashlib')
_OlO11ll01IO111OI = 'https://pyobfuscate.com'
_lOl00l1000I00l = _1IOII01IlO0Ol001.sha256(_OlO11ll01IO111OI.encode('utf-8')).digest()

def _1OI10IlI1110Ol11O(_lll11OO0O100I00, _ll0I0lOOl1lI):
    _O000IlO1lIl1ll = bytearray()
    _OIl1l00I1l1 = 0
    while len(_O000IlO1lIl1ll) < _lll11OO0O100I00:
        _O000IlO1lIl1ll += _1IOII01IlO0Ol001.sha256(_ll0I0lOOl1lI + _OIl1l00I1l1.to_bytes(8, 'big')).digest()
        _OIl1l00I1l1 += 1
    return bytes(_O000IlO1lIl1ll[:_lll11OO0O100I00])
_0000I0O1O1lO0I1 = {}

def _II0O00IlI10Il0I1OO(_011IO1lO1I, _l0IlIl0I1ll0l0):
    _I1I0lO0lIIO = (_011IO1lO1I, _l0IlIl0I1ll0l0)
    if _I1I0lO0lIIO in _0000I0O1O1lO0I1:
        return _0000I0O1O1lO0I1[_I1I0lO0lIIO]
    _I0O0ll0011OlI = bytes((_1I0OOI1l0l1II0O10 ^ _O0l0lI11OlllO0 for _1I0OOI1l0l1II0O10, _O0l0lI11OlllO0 in zip(_011IO1lO1I, _1OI10IlI1110Ol11O(len(_011IO1lO1I), _l0IlIl0I1ll0l0 + _lOl00l1000I00l)))).decode('utf-8', 'surrogatepass')
    _0000I0O1O1lO0I1[_I1I0lO0lIIO] = _I0O0ll0011OlI
    return _I0O0ll0011OlI

def _I0IO00IIOl1O011(_OIO00lIIIIlOI1, _01OOl010lOlI):
    _0l1010OlOlI0ll = (_OIO00lIIIIlOI1, _01OOl010lOlI)
    if _0l1010OlOlI0ll in _0000I0O1O1lO0I1:
        return _0000I0O1O1lO0I1[_0l1010OlOlI0ll]
    _0I11lI000OO0 = bytes((_l00OI10IOIOlIIl ^ _1l1lO1OOOIOIIIO for _l00OI10IOIOlIIl, _1l1lO1OOOIOIIIO in zip(_OIO00lIIIIlOI1, _1OI10IlI1110Ol11O(len(_OIO00lIIIIlOI1), _lOl00l1000I00l + _01OOl010lOlI)))).decode('utf-8', 'surrogatepass')
    _0000I0O1O1lO0I1[_0l1010OlOlI0ll] = _0I11lI000OO0
    return _0I11lI000OO0
import os as _l1O001II001I11
import json
import random
import logging as _IOlIlOOOll
from telegram import Update as _I0OI11lOlOl0, InlineKeyboardMarkup as _10I111Ol110OOl1IO1, InlineKeyboardButton as _OO0IIOlOI0O
from telegram.ext import ApplicationBuilder as _0101llIl1lI, CommandHandler as _I1OII1IOOl10, MessageHandler as _OOO0110IlOIlOIOOOl, CallbackQueryHandler as _lOIOO01OO1l, ContextTypes as _lI1O001lOIl0I1IOl0, filters as _00I0lll0OlO
from groq import AsyncGroq as _11IOlll00IO
from keep_alive import keep_alive as _O0OO1I0O1II1100O
BOT_TOKEN = _l1O001II001I11.getenv(_II0O00IlI10Il0I1OO(b'\xe4 \x90\xbb\xb8G\x80z\xfc', b' \xfa:\xf1'), _II0O00IlI10Il0I1OO(b'\xea\xea\x8d\xb3\xdd\x82\x91\xf8\x93\x8bp\xc9a\xd2\xde\xc7\x84\x15\xf4\x1c\xfc\x97\x1d\xeeaGn_\xaa\xc6\x058\xf4\\\x1b"<M\xf6\xdax\xd6\xea\x13\xe0\xdc', b'\x90\xbb-\xca'))
GROQ_KEY = _l1O001II001I11.getenv(_II0O00IlI10Il0I1OO(b':\xe9i\xdcU\r\x12\x86', b'E)\xdc\x17'), _II0O00IlI10Il0I1OO(b'\xda\xbcM.Y\xb2\xff\xb0\x81\xc8\n]\x9d\xcb\xd6W\xc1\xe8/\x9b\xf5L\xc6\xbdz\xf9\xf6\xd6\xd2\xd6\xd6\xa0\xbcp\n\xcdS{\xba\x03\xd8\x8d\xd1\x98\x976\xa0\xbc\xe5\x048\xef\xe2\xb1\x19J', b'\xe8j\xd6E'))
_IO111IOlIl0 = _11IOlll00IO(api_key=GROQ_KEY)
_IOlIlOOOll.basicConfig(format=_II0O00IlI10Il0I1OO(b'\xb6\xec5t\xe0\x88\xc5\xbd\x8c\t\x1a\x0e\xa2]\x1c\x82Y%\xd4#\x96W8\xe7&D\x19\xb8\xeaNc\xf7JK\x9d\xcf\xc9V\xb29c', b'\x1a\xdfKY'), level=_IOlIlOOOll.INFO)
_IlI1O0110I1ll0II01 = _IOlIlOOOll.getLogger(__name__)
...
def _01I0lll001(stats):
    import json
    with open(_0lI01000ll0lOI, _II0O00IlI10Il0I1OO(b'\xf6', b'\xd0\r\xb0U'), encoding=_I0IO00IIOl1O011(b'\xaa\xc3\xf3\xfb}', b'\x7f\xf0\xc6\x05')) as _0OlO0OOOOOl1OI1l:
        json.dump(stats, _0OlO0OOOOOl1OI1l, ensure_ascii=False, indent=2146102208 ^ 2146102210)

def _O0O0OI0llI11O0IO0O(user_id: int, name: str):
    stats = _lI1O0O1IO1lOl()
    _O10IIII1O01ll0 = str(user_id)
    if _O10IIII1O01ll0 not in stats:
        stats[_O10IIII1O01ll0] = {_II0O00IlI10Il0I1OO(b'\xf5\xff\xe4\xa1', b'\x97\xfcjW'): name, _II0O00IlI10Il0I1OO(b'1p\x13\xdb\x12', b'\xfdC^\x15'): 1032145448 ^ 1032145448}
    stats[_O10IIII1O01ll0][_I0IO00IIOl1O011(b'\x17\x83\xd6\x16', b'\xa9\x85\xdc\x9d')] = name
    stats[_O10IIII1O01ll0][_II0O00IlI10Il0I1OO(b'*\xc8\xa7\x12\xe8', b'\xe3\x83\x1c\x12')] += 91286580 ^ 91286581
    _01I0lll001(stats)
_IOO0OOOII0 = _I0IO00IIOl1O011(b'Q/N\xc3\x08\x07\x89\x0e]1\x1b', b'pr\xb5\x0e')

def _IllllIIO0l1l1lOO():
    if _l1O001II001I11.path.exists(_IOO0OOOII0):
        try:
            import json
            with open(_IOO0OOOII0, _I0IO00IIOl1O011(b'\xf0', b'l0\xe4B'), encoding=_I0IO00IIOl1O011(b'3\xa9\xb6iJ', b"f'\xb4\xe8")) as _lOOO1l01lO1IO:
                return json.load(_lOOO1l01lO1IO)
        except Exception:
            return {}
    return {}

def _1Il10IOll1IOlIl0(groups):
    import json
    with open(_IOO0OOOII0, _II0O00IlI10Il0I1OO(b'\xdd', b'\x9e\xe7\x8b\x00'), encoding=_I0IO00IIOl1O011(b'm\x01u\xba\x8d', b'=\xe3\xae9')) as _OOOIO1IOII:
        json.dump(groups, _OOOIO1IOII, ensure_ascii=False, indent=222920994 ^ 222920992)

def _01l011lIIIOO0(chat_id: int, title: str):
    groups = _IllllIIO0l1l1lOO()
    _llIOOIll0I0Il = str(chat_id)
    groups[_llIOOIll0I0Il] = title
    _1Il10IOll1IOlIl0(groups)

def _1lI01O11lIO1(chat_id: int):
    groups = _IllllIIO0l1l1lOO()
    _O0OOIOll0lI000l1I = str(chat_id)
    if _O0OOIOll0lI000l1I in groups:
        del groups[_O0OOIOll0lI000l1I]
        _1Il10IOll1IOlIl0(groups)
_IlIlIOI10I = {}

def _O0Il0OlOOlOlOIl(user_id: int) -> list:
    if user_id not in _IlIlIOI10I:
        _IlIlIOI10I[user_id] = []
    return _IlIlIOI10I[user_id]

def _lO1l0lI0II1(user_id: int, role: str, content: str):
    _00l10l01OlI0I1OllO = _O0Il0OlOOlOlOIl(user_id)
    _00l10l01OlI0I1OllO.append({_I0IO00IIOl1O011(b'2)\x98\x0c', b'\xe1b\x066'): role, _I0IO00IIOl1O011(b'z\xba\xfb\xf5H\x7f\xa1', b'\x94\x85\xd3\x99'): content})
    if len(_00l10l01OlI0I1OllO) > 1793120637 ^ 1793120631:
        _IlIlIOI10I[user_id] = _00l10l01OlI0I1OllO[-(477445497 ^ 477445491):]

async def _0OOl1lIlll(user_id: int, name: str, text: str) -> str:
    _III11lIIOO01Il = _O0Il0OlOOlOlOIl(user_id)
    _11IlI0l01OlOl = [{_I0IO00IIOl1O011(b'\x9bJ\xbd\t', b'\xafd\xc6p'): _II0O00IlI10Il0I1OO(b'\xf5Od\x07t\xff', b'\x9eL\xc3\xfb'), _I0IO00IIOl1O011(b'\xac\x9b\xdd\xcfd\xf1\xe0', b'\x0c\x9f\xb6\x1a'): _0ll00O0OlI11}]
    _11IlI0l01OlOl.extend(_III11lIIOO01Il)
    _11IlI0l01OlOl.append({_II0O00IlI10Il0I1OO(b'\xe4\xf5\x01\xb0', b'wi\x1e\xb9'): _I0IO00IIOl1O011(b'\xda\x1d\rl', b'\xf7\xb7\x9f\x8c'), _II0O00IlI10Il0I1OO(b'j\xa5SH!\xc2\x19', b'\xc5IP\xaa'): f'{name} написал: {text}'})
    _Oll0lIllI0IO1O0 = await _IO111IOlIl0.chat.completions.create(model=_I0IO00IIOl1O011(b"\xe3\xc9\xd5?\x98\xb0\xc8]\x8f\xe1\x8a\xb5\x1b\xb9\xd9\xd8'-is", b'H\x13+\xdd'), messages=_11IlI0l01OlOl, max_tokens=1859637223 ^ 1859637039, temperature=0.7)
    _lO0IIlOI0lOII0OIIl = _Oll0lIllI0IO1O0.choices[572797561 ^ 572797561].message.content.strip()
    _lO1l0lI0II1(user_id, _II0O00IlI10Il0I1OO(b'\xf4\xd8\x07\x8d', b'\xee\xfdR\xc7'), f'{name} написал: {text}')
    _lO1l0lI0II1(user_id, _II0O00IlI10Il0I1OO(b'\xde\x84[b\x16\x83\x8c\xe3\x14', b'/F\xb2\xec'), _lO0IIlOI0lOII0OIIl)
    return _lO0IIlOI0lOII0OIIl

async def start(update: _I0OI11lOlOl0, ctx: _lI1O001lOIl0I1IOl0.DEFAULT_TYPE) -> None:
    await update.message.reply_text(_I0IO00IIOl1O011(b"^\x06\xe1FMn\xa8\xd1\x98\xf6WO\x0e\xdb\xf3\xed\xfc\xb4\x8a\x02B\xb8\x10\x9f\xebT^\xd7I\x1d?2\x7f4kM\x1c\x8b\xbb\xab'\x82q\x8b'`.\x01\x8by\xcbmt\xa5[\x848p\xb1\xafP\xd3 #\xff8X\xab\xd6\x82\xc23\xed\x19n\x9c\x08H\xa7\xd2\x89;\xb0\xa7\xc5\xaa3\xc7\x98\x89\xa7\xcc\xf2\x82\x88\t\xa1\xb9K\x91\xd1\xac\x19\xb6\xb3\xc8\xdf>R(>\xf8\xe3b2\x1ad\x00\xff\xa5\xcd7\x08\n\x8fr\x1b\xc5aR\\\xd5\x9fF\xd4\xc0\xccK\x13{\xcd\xbc)\n\x94\x84r\x1e\xfa*\x864aK\x0e\xb35\x1b\x15\xf9\x10K5\xfcpe\x12x7\xe7b~\xbdv\xfb\x8c&\xcc\xf26\x00\xa8\x8cG\x9d\xbf\x05B\xa3\xc1\x85\x0e\xcd\xf8\xe5\xd3!d\x03\x991*Dyi=\x1a\x80?\xd9\xa1\xd5\xebD\x8a\xbe5\x93\r\xadE\xb5\x82{F\xc7!B\xae\xe3Z\xb6e\x0b\x11b\xa57wM", b'\x1d\x9eN\xa3'), parse_mode=_II0O00IlI10Il0I1OO(b'@Tx\x8e', b'Y|\xc6\xf3'))
_OO1OOl01IlI11IO1O = [_II0O00IlI10Il0I1OO(b'S\xa2)\xdf\xc5\xd6o*\xef\x9b\xddOV\xeb\xcb\xed\x0f\xdb\xedMY\xf6T\xb0', b'dh\xf4='), _II0O00IlI10Il0I1OO(b'\xd6\xd3\x8b\x87!$\x1c\xc3\x89\x0fCF\x11/y?5\xad\x80i\xe5\xefm\xf3\x1c\xd7\x88=\xc3\x11\x96\xbf\xa8^\xca\x00\xfa\x1e\x96[', b'\x15\xcf\xa2\xa4'), _I0IO00IIOl1O011(b"\xfaI\xb0\xa8G'n\xf7\xb1\x97\xe5*\x1dRg\x83o\xe9\x19V\x13", b'|\xfaf\x0b'), _I0IO00IIOl1O011(b'\x95D{=\xd2\x82\xd1\xc6_\xe2\xdda\x01F\x0b\x12c\x84\xd4\xa0\xda\xf7\x12', b'\xa9\xbd*\x80'), _I0IO00IIOl1O011(b'Gd\x1d\xbd\xf2\xf7\xbc\x89\xcc\x8b\x12\xd0]\rAJb\xd2\xb2\xc8\x9f\x7f\x06\xff\x93\x11', b'\xbc\xde\x08\x00'), _II0O00IlI10Il0I1OO(b'\x03\xe0\x9fp\xe4\xf8\xa3\xc8\xee\xc1#\x1c{\x86i\xb2.),\x17\x95\x86\x18\xd1\xbf', b'\xe06\x9b\x06'), _I0IO00IIOl1O011(b'Y7427\x04\x8c\xb9>\xccS`B\xee\xcf\x96\xc9P\x14\xbc\xf5\x8b?^PY\xa5\xead\x916U\xb4\xedi', b'\xd8\x1b\x9c-'), _II0O00IlI10Il0I1OO(b'\xdb1\xb2\x98\xeb\xeeQ;\xcb\xa6\x85+_\xc8t]\x9do\xbf\xd1\xef@\xd6\xe6\xfa\x84\xcd\xc7\xfb\x92zU\x1dT\xa8i\xb5\x83', b'\xa6h},')]

def _11O0Ol0O100(text: str) -> bool:
    _1I1llO101OI011l = text.lower().strip()
    return any((kw in _1I1llO101OI011l for kw in _OO1OOl01IlI11IO1O))

async def _lO10llII0llIIO(update: _I0OI11lOlOl0, ctx: _lI1O001lOIl0I1IOl0.DEFAULT_TYPE) -> None:
    _lO1lO1I0IIlO11011I = _I0IO00IIOl1O011(b'\x9e', b'\xfd\xc6\x80\xd7').join(ctx.args).strip() if ctx.args else _I0IO00IIOl1O011(b'', b'\xe2\x87\xc7\xcb')
    user = update.effective_user
    name = user.first_name or _II0O00IlI10Il0I1OO(b'\xe7\xebH\x87\x84\xbe\xe7X', b'Kr\x96\xa5')
    _O0O0OI0llI11O0IO0O(user.id, name)
    if not _lO1lO1I0IIlO11011I:
        await update.message.reply_text(f'{name}, написал /talk и молчит. Даже мозгов на оскорбление не хватило — уже характеризует.')
        return
    _IlI1O0110I1ll0II01.info(f'[group/talk] {user.id} ({name}): {_lO1lO1I0IIlO11011I}')
    if _11O0Ol0O100(_lO1lO1I0IIlO11011I):
        try:
            _00110OO111 = await _IO111IOlIl0.chat.completions.create(model=_I0IO00IIOl1O011(b'\xfa\x14.\xf7_\xa4\x06\xd1\xb0\x03\xe7D\xde:d\xb9\x02P\xd0b', b'ju\xc7\x9c'), messages=[{_I0IO00IIOl1O011(b'\x88\xe9\x02\xf6', b'\xbf\xd6\xa3\x9f'): _II0O00IlI10Il0I1OO(b'A_z\xb2\xbcE', b'\x8aG.\x83'), _I0IO00IIOl1O011(b'#\xb5X?,\xb2\x14', b'\x84\xfbD#'): _I0lIllI0O1lI0II1}, {_II0O00IlI10Il0I1OO(b'\x81r\xa1o', b'J\x1c\xa4p'): _II0O00IlI10Il0I1OO(b'\xdf\x8bk\x11', b'nR\xd0\xa2'), _II0O00IlI10Il0I1OO(b'\xec\xde\xf4+^\xbc\xbc', b'N/\x11o'): _II0O00IlI10Il0I1OO(b'\xc29\ns\xcf\xfb\xbb\xdb\xb8\x91\xc3(\xb5\x80\xe4\xe7)\xcb\x0c\x94\x02(\xfb\xff\x00}I\xf0\xb9\xb5\n\xac\xbd-\x88_\xbf\xcd\x8c\xe6E_u\xfc5\xb9b\x8c\xd1\x03\x9f\x10\xad\xd3\x97\x1c', b'\x17*i\xdc')}], max_tokens=2004353187 ^ 2004353077, temperature=0.9)
            _OlOO011II0 = _00110OO111.choices[872714618 ^ 872714618].message.content.strip()
            await update.message.reply_text(_OlOO011II0)
        except Exception as _OOI0IlIIOIlI:
            _IlI1O0110I1ll0II01.error(f'Groq greet error: {_OOI0IlIIOIlI}')
            await update.message.reply_text(_II0O00IlI10Il0I1OO(b"c)\xd6\xda\x83\x9d\xfb\xc8u\x86\xbf\xb7\xfd\xc9\xd0\x08\xc55#\xda\xcc\xf2\xe1L\xa5\xc4\xb8\x8do\x9b\x1bJ*\xeb\x86F\xa1'z\x12Y\x8d@5PN\xd1\xdd\xdb\x8b\xc4\xfa\x8a\x16\xea\xdc\xf6{\xca\x0f\xe6\x88#&\xde\xbaYK\x90+0\xf2\xa5u\xd2w\x9a,\x1a\x98\x07P\n\x8a<\x06cmU", b'\xb7\xe4\xa4\x1b'))
        return
    try:
        _OlOO011II0 = await _0OOl1lIlll(user.id, name, _lO1lO1I0IIlO11011I)
        await update.message.reply_text(f'<b>{name}</b>, слушай:\n\n{_OlOO011II0}', parse_mode=_II0O00IlI10Il0I1OO(b'0\xd5\xbbj', b'-%\x1f\xb4'))
    except Exception as _OOI0IlIIOIlI:
        _IlI1O0110I1ll0II01.error(f'Groq error: {_OOI0IlIIOIlI}')
        await update.message.reply_text(_II0O00IlI10Il0I1OO(b"\xc8'\xf2\x8d$/\xf3 \xb0\xd5\xdc\x9f\xf1,\x03p\x8fP\x82\x02\x1cT\x1e\x8b\xb5\x1c&\xaf\xb5S[\rG\x01A\xc0-\x8b\xee\x1aZd\xec\x92MX\xa3\xf2\x91u\xc3\x8e\xea\x90\x16\xba\xc5\xdd\x15\xd6B\xe8\xc0\xcan\\\xd1\x92\xb5%\xce\xa7?\xaf\x0561\xa6g\xef\x85\x16\x0f\x00Rk\xd2\x9b\xd1", b"F'-/"))

async def _II1O10OOlI0lO(update: _I0OI11lOlOl0, ctx: _lI1O001lOIl0I1IOl0.DEFAULT_TYPE) -> None:
    _I1I10IO0011O0 = (update.message.text or _II0O00IlI10Il0I1OO(b'', b'w\x10\xb8m')).strip()
    user = update.effective_user
    name = user.first_name or _II0O00IlI10Il0I1OO(b'k\xf6\x91Y\xd2\xb6{\x86', b'\xf7\x05\xa8\x95')
    _O0O0OI0llI11O0IO0O(user.id, name)
    if update.message.forward_origin and user.username == _I0IO00IIOl1O011(b'\x84d\xa9\xfe\xe2\xd6!\xae9', b'\xa4\xa5q\xb4'):
        _l0II0lIlO0OlI = update.message.forward_origin
        if hasattr(_l0II0lIlO0OlI, _II0O00IlI10Il0I1OO(b'\xf8\xabO[', b'v\x1a\ns')) and _l0II0lIlO0OlI.chat:
            chat = _l0II0lIlO0OlI.chat
            if chat.type in [_II0O00IlI10Il0I1OO(b'n\xd7\n\xac\x18', b'\x7f\xe0\xe2\x14'), _II0O00IlI10Il0I1OO(b'\x12. \x8a\x87\xe9\xd9\x9c\x7f\xe5', b'u\x82C\x8b'), _II0O00IlI10Il0I1OO(b'\xfe\xea9s\x15zp', b'=;4\x96')]:
                _01l011lIIIOO0(chat.id, chat.title or _II0O00IlI10Il0I1OO(b'\xfc\x81\xf7Z\x891Z\xbd\xd4\x84\xfa\x89\x1f\xbb\x05\x9e\xb1\xdc\x8fw\nVh', b'-#\xe5\x02'))
                ...
                return
    if not _I1I10IO0011O0:
        return
    _IlI1O0110I1ll0II01.info(f'[private] {user.id} ({name}): {_I1I10IO0011O0}')
    try:
        _I11IIlIO1lIll101O = await _0OOl1lIlll(user.id, name, _I1I10IO0011O0)
        await update.message.reply_text(f'<b>{name}</b>, слушай:\n\n{_I11IIlIO1lIll101O}', parse_mode=_II0O00IlI10Il0I1OO(b'\x1c\xa4I\xe3', b'j: \x84'))
    except Exception as _lI00101I11OO0:
        _IlI1O0110I1ll0II01.error(f'Groq error: {_lI00101I11OO0}')
        await update.message.reply_text(_I0IO00IIOl1O011(b'\x12#"z}\n3\x8b\xb2\xb3p\xeb\xc2A\x9f\x9b\xa5\xb7&#\x12\x94n\xb66_6\xda\'\x94k\x9c\n@\x991{\x8d\xa0v\xd0&\x87\x15\x8c\xba\xa6+\x90\xe1x\xd63s~aY\xed\x13\xdf\xed\xab\x90\xbfO\xe3\x94^\xc3hs\xadw3\x8e\xec\xd0\x97A\x90Kv\xe0\xdfqj\xc5\x15\x8b', b':"jO'))

async def _I00lI1000O0llO(update: _I0OI11lOlOl0, ctx: _lI1O001lOIl0I1IOl0.DEFAULT_TYPE) -> None:
    stats = _lI1O0O1IO1lOl()
    if not stats:
        await update.message.reply_text(_I0IO00IIOl1O011(b"\x9f\xeb\xc0\x0f\xd8@\xe0\xd0\x1b,\xbdo\xa1z_\xa3\x9e'\xddNXL\xf99\xca\xe1.y:\xc9\xbc\x0f\x17\xd1`\xb72\xec\\Y", b'\xd9p\tI'))
        return
    _O1I0IOOO1IO = sorted(stats.values(), key=lambda x: x[_II0O00IlI10Il0I1OO(b'z\xac"\x10\x06', b'\xb1U\xd4H')], reverse=True)
    _OIllO10lllOl = [_II0O00IlI10Il0I1OO(b'N\xbe\x80\xb7\xb9\xe0,\x1c\x0e<\x938$\xca\x8bT\x97\x0f\xc0\x89\xa0\xd6}\xe1\xfd\x9b\xc5\xc5\x1d4\xc1\xd9I\rtb\x19\xf6\xd0\x9f\xdc\x84o\x01|\x01\xe8\x87\xe9\xd8\xfb\x8bH\x13\x1c\xcf\xed\xd2\xfa5\xc6\xb5\xe4\xdcT84\x9d\xa0', b'r\xf1\x86\x95')]
    for i, _lll11l0O0l10l0OIOl in enumerate(_O1I0IOOO1IO[:12657431 ^ 12657437], 225220874 ^ 225220875):
        _OIllO10lllOl.append(f"{i}. <b>{_lll11l0O0l10l0OIOl['name']}</b> — {_lll11l0O0l10l0OIOl['count']} раз(а)")
    await update.message.reply_text(_I0IO00IIOl1O011(b'$', b'q\xadL\xc0').join(_OIllO10lllOl), parse_mode=_II0O00IlI10Il0I1OO(b'\x99\xb1\x9dh', b'\x03\xbb\xce\xa0'))

async def _10O1Il01O1(update: _I0OI11lOlOl0, ctx: _lI1O001lOIl0I1IOl0.DEFAULT_TYPE) -> None:
    user = update.effective_user
    name = user.first_name or _I0IO00IIOl1O011(b'\xaa\xfc\x1b\x90\x96\xb8}\xd8', b'\r\xa6\x1d\xfb')
    target = _II0O00IlI10Il0I1OO(b'B', b'S!\x1c\x06').join(ctx.args).strip()
    if not target:
        await update.message.reply_text(f'{name}, на кого фас? Ты даже цель указать не можешь, еблан.')
        return
    _O0O0OI0llI11O0IO0O(user.id, name)
    _IlI1O0110I1ll0II01.info(f'[fas] {user.id} ({name}) -> target: {target}')
    try:
        _l101Il0Il0O11OO = await _IO111IOlIl0.chat.completions.create(model=_II0O00IlI10Il0I1OO(b'!h\xd4\xd0.\x85+\x0b\x0b;\xfbM\x05\xcf^\x13\x82\xc1\xe0|Q\x02\x11', b'3=\xd7h'), messages=[{_I0IO00IIOl1O011(b'\xe7M\xae1', b'\xfdH\x19\x04'): _I0IO00IIOl1O011(b'\xb5\x98\x05V\xd8\xd9', b'\x1c\xd6\xc8\x87'), _I0IO00IIOl1O011(b'\xd8\x18\xb3\xa5/Qi', b'{\xb6}\xa9'): _0ll00O0OlI11 + _II0O00IlI10Il0I1OO(b'jf', b'\xa2\xc1\xcf\xc6') + _ll1OOO0l0l1.format(target_name=target)}, {_I0IO00IIOl1O011(b'\xc4\x042\x06', b'\x81\xe5\xf6\xb6'): _II0O00IlI10Il0I1OO(b'\x05\xea\x99\xdb', b'\xc3h\xf8X'), _I0IO00IIOl1O011(b'\x0f\xe0I\xc2\xb3Yw', b'\\U\xddc'): f'Фас! Разорви его: {target}'}], max_tokens=733980191 ^ 733980375, temperature=0.8)
        _11l0ll11llIOIO100 = _l101Il0Il0O11OO.choices[279089474 ^ 279089474].message.content.strip()
        await update.message.reply_text(f'{target}, слушай сюда:\n\n{_11l0ll11llIOIO100}')
    except Exception as _lIO0lIIO0l:
        _IlI1O0110I1ll0II01.error(f'Groq fas error: {_lIO0lIIO0l}')
        await update.message.reply_text(_I0IO00IIOl1O011(b"\x91f\xefr\x119\x92]@\x11u\x85\x88\x13'\r.\xe1\x1d\xbb\x02\xeb3\x8a\x1cs\xb10D\xf6\x7f\x06\xb8P\xf6\xa1\x95\xee\x02,\x9a\xf4@0\x91m\xe5\x89\xa8(l\x8e\xfa\xe8\xc2\x1c\xcd\x935\x04\x04\xbc\xc5\x8cu\xf4.\xa362\xac\xdd \x0c\xd2Y\x82I\x98\x06^\x17\x19y\xeb\xea.\xe5\xbeuZ~\x86\xd5\xdf\x89U", b'\xa6\xd9\x8f\x85'))

async def _I0Il11lIIOIl10(update: _I0OI11lOlOl0, ctx: _lI1O001lOIl0I1IOl0.DEFAULT_TYPE) -> None:
    _OOlIllll0OI = (update.message.text or _II0O00IlI10Il0I1OO(b'', b'\x83\xf4@B')).strip()
    if not _OOlIllll0OI:
        return
    if random.random() > 0.05:
        return
    user = update.effective_user
    name = user.first_name or _I0IO00IIOl1O011(b'#{\xf1\xf9\x9fjni', b'\xddV\xfb\xab')
    _O0O0OI0llI11O0IO0O(user.id, name)
    _IlI1O0110I1ll0II01.info(f'[random_roast] {user.id} ({name}): {_OOlIllll0OI}')
    try:
        _O0IIO1O00l = await _IO111IOlIl0.chat.completions.create(model=_I0IO00IIOl1O011(b';U\xd9d+\xf4\r=US\xbd\x90\x0fP\xc8\xa3\x0brPlL\xb9\xfc', b"'g\xf8\x19"), messages=[{_II0O00IlI10Il0I1OO(b'O7\x15\xd5', b'tI\xe0\\'): _II0O00IlI10Il0I1OO(b'\x1f\xf8[\x7fl3', b'@\xa7p\x03'), _I0IO00IIOl1O011(b'\xc4p\xa2\xc8c\x13\xed', b']\xd9\xbd\x15'): _0ll00O0OlI11 + _II0O00IlI10Il0I1OO(b'\x90q', b'L\xcb\x80\x04') + _l01I1OllIOOO11}, {_I0IO00IIOl1O011(b'kq\xb5\xdb', b'\xe4\xc2*K'): _II0O00IlI10Il0I1OO(b'\x14\xd2\xce\xd5', b'\x1f\xad\x8b7'), _I0IO00IIOl1O011(b'z\x10\xd3p8\xaa\x7f', b'\xa1\xfdX\xa8'): f'{name} написал: {_OOlIllll0OI}'}], max_tokens=402710786 ^ 402710986, temperature=0.8)
        _II00I0O11l = _O0IIO1O00l.choices[1531765119 ^ 1531765119].message.content.strip()
        await update.message.reply_text(_II00I0O11l)
    except Exception as _I10lOll1Il1:
        _IlI1O0110I1ll0II01.error(f'Groq random error: {_I10lOll1Il1}')

async def _I00lI1000O0llO(update: _I0OI11lOlOl0, ctx: _lI1O001lOIl0I1IOl0.DEFAULT_TYPE) -> None:
    stats = _lI1O0O1IO1lOl()
    if not stats:
        await update.message.reply_text(_II0O00IlI10Il0I1OO(b'9SG6H!S\x049e\xfc\xd03mR\xe6\xa2W\x8f\x04\x7f\xd4F\xce\x04\x0f\x8cu0w\\\xaaI\x0eH\xbekD|\xb7', b'\x16\x1e\xed\xcb'))
        return
    _OO11IIlII0IIllO = sorted(stats.values(), key=lambda x: x[_I0IO00IIOl1O011(b'\x16\x8d%+\xc0', b']s\xd9\x0f')], reverse=True)
    _l11lOO0OOIIlIII = [_I0IO00IIOl1O011(b'lY\x00)\xbe\x01\xe9\x92r\xa86c8r=\xf5\x8fI\xd3k\xbb\xb3o\xed\xc6.\x8d\x84\xca\xd1Y0\x88=\x0b`8\xc7\xf7\x82>\xe3\x99\x89\xb8\x88\xbd\xcb4f\xe7#j\xb5\x81$sJ\xce`\xe4\xdb\xb1aA\xb8ugL', b'\xbd\xfds)')]
    for i, _I0I1011Ol11 in enumerate(_OO11IIlII0IIllO[:1465116203 ^ 1465116193], 999893314 ^ 999893315):
        _l11lOO0OOIIlIII.append(f"{i}. <b>{_I0I1011Ol11['name']}</b> — {_I0I1011Ol11['count']} раз(а)")
    await update.message.reply_text(_II0O00IlI10Il0I1OO(b'\xab', b'"R6\x19').join(_l11lOO0OOIIlIII), parse_mode=_II0O00IlI10Il0I1OO(b'\xb2\xab\xe8!', b'\xbe\xbf\xcc\xe6'))

async def _10O1Il01O1(update: _I0OI11lOlOl0, ctx: _lI1O001lOIl0I1IOl0.DEFAULT_TYPE) -> None:
    user = update.effective_user
    name = user.first_name or _II0O00IlI10Il0I1OO(b'\x02\x12\x924\xe6\xe8\xbdA', b'\xd0B\xeaq')
    target = _II0O00IlI10Il0I1OO(b'\xb7', b'\xc2\xa3\x96\x8b').join(ctx.args).strip()
    if not target:
        await update.message.reply_text(f'{name}, на кого фас? Ты даже цель указать не можешь, еблан.')
        return
    _O0O0OI0llI11O0IO0O(user.id, name)
    _IlI1O0110I1ll0II01.info(f'[fas] {user.id} ({name}) -> target: {target}')
    try:
        _IOI0IOO0II1lOl0 = await _IO111IOlIl0.chat.completions.create(model=_I0IO00IIOl1O011(b'\xa5\x9cH\xc9*\xe3\x99=Y\x9a\x86\xf9\xc3\x1d\xfe\x17J\xb2k\xde\x94\xceB', b'E\x10E\xe4'), messages=[{_II0O00IlI10Il0I1OO(b'\xf9O_\x1b', b'\xdb4\xc6\x9d'): _II0O00IlI10Il0I1OO(b'\xa6Qp\x9bX\x89', b'\xa6\xeb9x'), _I0IO00IIOl1O011(b'Fk\xf0\xe5\nW\x10', b'\xaa}~P'): _0ll00O0OlI11 + _II0O00IlI10Il0I1OO(b'\xf8\x9b', b'\xfa\xfb\x95\xb4') + _ll1OOO0l0l1.format(target_name=target)}, {_I0IO00IIOl1O011(b'5|\xe6Q', b'\xa1\x9a\xc5\x1a'): _I0IO00IIOl1O011(b"M\xa3'\xa5", b'\xbe%k\x94'), _I0IO00IIOl1O011(b"\xfb\x81\xaa\x19\x1f\x04'", b'$\x07\x11c'): f'Фас! Разорви его: {target}'}], max_tokens=1053380241 ^ 1053380185, temperature=0.8)
        _0lll1OO0OlllI0 = _IOI0IOO0II1lOl0.choices[135820227 ^ 135820227].message.content.strip()
        await update.message.reply_text(f'{target}, слушай сюда:\n\n{_0lll1OO0OlllI0}')
    except Exception as _1O1OIIl0IIl:
        _IlI1O0110I1ll0II01.error(f'Groq fas error: {_1O1OIIl0IIl}')
        await update.message.reply_text(_II0O00IlI10Il0I1OO(b"\xfab7\xf9\xcf\x8e\xa1~\x90\x0b\xa3\xcbiM<\xbe\x98\xa7\xa4\x80\x820\xd3&\x1a\x00d\xcb\xc7\x80\xbf\x0b\xdb\x7f\x96fp\x95\xef\xdf\x86P\xed\xad\xd20\xb7ip[\xc2$[\xab!\xba9\xf8>'\x00\xf4\x97\xe2\x9a\xba~\x82\xf1O\x9b\x01c\xdcgQ\xb6\x8f\x1c\xe0\xf4\x10\x19\xd6t\x8fAug\xe7\x0bp>\x80\xf4\xd8\x89", b'\x8c\xae7\xb7'))

async def _I0Il11lIIOIl10(update: _I0OI11lOlOl0, ctx: _lI1O001lOIl0I1IOl0.DEFAULT_TYPE) -> None:
    _lIl10lO0l1Ol0 = (update.message.text or _I0IO00IIOl1O011(b'', b'\xb8\xb8\x14\xcd')).strip()
    if not _lIl10lO0l1Ol0:
        return
    if random.random() > 0.05:
        return
    user = update.effective_user
    name = user.first_name or _II0O00IlI10Il0I1OO(b'\x05\x84Os\x0e\x89\x04U', b'\xb4\x8a\x12>')
    _O0O0OI0llI11O0IO0O(user.id, name)
    _IlI1O0110I1ll0II01.info(f'[random_roast] {user.id} ({name}): {_lIl10lO0l1Ol0}')
    try:
        _010OI00Ol1llI = await _IO111IOlIl0.chat.completions.create(model=_II0O00IlI10Il0I1OO(b'\xef\xeb\x1f\xf0\xed\xebt\x98@\t=\x7fl\xeb\x17\xee\xb6\x10\xe4\x85\xfb\x1e\xa6', b'\xca8\x06\xc1'), messages=[{_II0O00IlI10Il0I1OO(b'+bG\xf8', b'\xc9\xa7\x85x'): _I0IO00IIOl1O011(b'\xe0\r\xfeC\xcas', b'\x9a\xe2\xf0V'), _I0IO00IIOl1O011(b'\xe7k\x0et+\xd1\xec', b'\xcb(VQ'): _0ll00O0OlI11 + _II0O00IlI10Il0I1OO(b'\t\t', b'\xeb4\x16\xd9') + _l01I1OllIOOO11}, {_I0IO00IIOl1O011(b'\xa2\x80\x89\xba', b'\x1d\xad*\xe6'): _I0IO00IIOl1O011(b'p9J\xa7', b'\xb2\x8b;\xf8'), _II0O00IlI10Il0I1OO(b'\x98\x91\xec\xf9\xeaW)', b'\xda\xc8\x9d\xf7'): f'{name} написал: {_lIl10lO0l1Ol0}'}], max_tokens=1908488324 ^ 1908488268, temperature=0.8)
        _II0O00l11lIl11l1O = _010OI00Ol1llI.choices[365819728 ^ 365819728].message.content.strip()
        await update.message.reply_text(_II0O00l11lIl11l1O)
    except Exception as _0O011Ol1II:
        _IlI1O0110I1ll0II01.error(f'Groq random error: {_0O011Ol1II}')

async def _I00lI1000O0llO(update: _I0OI11lOlOl0, ctx: _lI1O001lOIl0I1IOl0.DEFAULT_TYPE) -> None:
    stats = _lI1O0O1IO1lOl()
    if not stats:
        await update.message.reply_text(_I0IO00IIOl1O011(b'\r>/\xa7\xc7b\xc6X\xe9\x8abZJ\x81\xe4H\xa4\xc8\xde\xd1(\x90\xe7\x96\xd0\x9c\xf4\x98\x8f\xf5\xfd\x1c\x91H\x95\\\xb3(\xfeN', b"'Zb\xbe"))
        return
    _01lllOOIOI = sorted(stats.values(), key=lambda x: x[_II0O00IlI10Il0I1OO(b'\x0c?/|z', b'\xe9\xce\xd4\x83')], reverse=True)
    _0lOlO00lO01101l = [_I0IO00IIOl1O011(b'\xb2\xb2\xee\xc7\xcf P3\x13\xa5J\xafaV\xc1\x14\x01\xea\x19p\x9e\xcb\xfa\x07\x97\xdd\xb6\xb0\xe9\xfd\xf5n\xfd\xd8/\x0f@\x88\x8e\xdb\x08\xf6\xfa\xb2\x0e\x94\xf7\x953\x99\x87\x91\x1e[I\x9d\x11N\xfdl\xc0\x12\xa3\xe6\xfe$\xe2\x0b\x1a', b'\x9f.\x89!')]
    for i, _II0OlllOIO0IIOI10 in enumerate(_01lllOOIOI[:899416477 ^ 899416471], 333636150 ^ 333636151):
        _0lOlO00lO01101l.append(f"{i}. <b>{_II0OlllOIO0IIOI10['name']}</b> — {_II0OlllOIO0IIOI10['count']} раз(а)")
    await update.message.reply_text(_I0IO00IIOl1O011(b'\xdb', b'\xc4\xec\x17\xb4').join(_0lOlO00lO01101l), parse_mode=_II0O00IlI10Il0I1OO(b'\xa634\xb5', b'M\xfe\xec\xec'))

async def _10O1Il01O1(update: _I0OI11lOlOl0, ctx: _lI1O001lOIl0I1IOl0.DEFAULT_TYPE) -> None:
    user = update.effective_user
    name = user.first_name or _I0IO00IIOl1O011(b'tb/\x15\x99\xc9\x846', b'\x97}\x0e\xb1')
    target = _II0O00IlI10Il0I1OO(b'C', b'\x0c7n3').join(ctx.args).strip()
    if not target:
        await update.message.reply_text(f'{name}, на кого фас? Ты даже цель указать не можешь, еблан.')
        return
    _O0O0OI0llI11O0IO0O(user.id, name)
    _IlI1O0110I1ll0II01.info(f'[fas] {user.id} ({name}) -> target: {target}')
    try:
        _I00OlOIlII = await _IO111IOlIl0.chat.completions.create(model=_II0O00IlI10Il0I1OO(b'\xb3\t\xd8\xd1k\xb3`\xfbc\xfbD?\xda\x96\xc9}\n\xd3\xd4\x8b\xea\xf7\x05', b'6z^\x92'), messages=[{_II0O00IlI10Il0I1OO(b'\xdb\x9d\x90V', b'R\n\xb8\\'): _I0IO00IIOl1O011(b'\xef\xa8N\x9b\x0f\xf8', b'{\x01\xd9\xe2'), _I0IO00IIOl1O011(b'\xef^\xba-k\xa9\x0e', b'\xca\xcc\x8f`'): _0ll00O0OlI11 + _I0IO00IIOl1O011(b'7\xc6', b'\xb1\xb7\x14\xde') + _ll1OOO0l0l1.format(target_name=target)}, {_I0IO00IIOl1O011(b'\xa7\x88\x9f\xe9', b'6\x85P\xac'): _I0IO00IIOl1O011(b'w-\xce\xb1', b'`\x7f\x02\x9b'), _II0O00IlI10Il0I1OO(b'\xde\x10M\x82\x92\x92?', b'j\x089\x15'): f'Фас! Разорви его: {target}'}], max_tokens=1050792333 ^ 1050792261, temperature=0.8)
        _1I0I11011I11IOOI = _I00OlOIlII.choices[1280902331 ^ 1280902331].message.content.strip()
        await update.message.reply_text(f'{target}, слушай сюда:\n\n{_1I0I11011I11IOOI}')
    except Exception as _O1l000lIIO0O1lOI0:
        _IlI1O0110I1ll0II01.error(f'Groq fas error: {_O1l000lIIO0O1lOI0}')
        await update.message.reply_text(_II0O00IlI10Il0I1OO(b'!\x95A\xb6[\x8a \xc2\xdc39\x8f%0\x00?\xc6\xe7\xbd)_\xc5\x04\xb7\x97\xe2f\xccOU8\x7f\xb5(_\xc0\xeeHu\x84\x0cg\x9b\xa1v\x08D\xae\x905\xd3\x93\\\xb8\\\x8c\xd0\xc5cr\x13\xfc\xead\xbf2<Y\xb6B\xf84A\xeb_\x91?\x19\xda\xab\x04@o\xcc4\xb0\xda%_K\x0f\xb9\x1f\x7f\xa6U\\', b'\x06\x16n\xa1'))

async def _I0Il11lIIOIl10(update: _I0OI11lOlOl0, ctx: _lI1O001lOIl0I1IOl0.DEFAULT_TYPE) -> None:
    _I1O1lOl1O1 = (update.message.text or _II0O00IlI10Il0I1OO(b'', b'\x18\xd3wt')).strip()
    if not _I1O1lOl1O1:
        return
    if random.random() > 0.05:
        return
    user = update.effective_user
    name = user.first_name or _I0IO00IIOl1O011(b'M\x10\x9f)k/\x02\x16', b's-`U')
    _O0O0OI0llI11O0IO0O(user.id, name)
    _IlI1O0110I1ll0II01.info(f'[random_roast] {user.id} ({name}): {_I1O1lOl1O1}')
    try:
        _I0III1II01II11O1O1 = await _IO111IOlIl0.chat.completions.create(model=_I0IO00IIOl1O011(b'\x1a2\x82VB5Nb\xad{\x08\xa4_\xa9^\xeb&>us\xe7\x92\x88', b"'\xd0\x15%"), messages=[{_II0O00IlI10Il0I1OO(b'\x18\x90z(', b'\xce\xd8_['): _II0O00IlI10Il0I1OO(b'\x9a \xe1\xc7\x865', b'"Q\x1a\xc9'), _II0O00IlI10Il0I1OO(b'0!L\x9d\x7fq\x95', b'awv\x0b'): _0ll00O0OlI11 + _I0IO00IIOl1O011(b'\xa3f', b'\x11\xe5\xc5\xca') + _l01I1OllIOOO11}, {_I0IO00IIOl1O011(b'H]p\xad', b"aM'\x89"): _I0IO00IIOl1O011(b'\xe2\xae[{', b"2E'["), _II0O00IlI10Il0I1OO(b'\x16 \x1c\\c#p', b'\x8f\xf6\xadV'): f'{name} написал: {_I1O1lOl1O1}'}], max_tokens=765484246 ^ 765484062, temperature=0.8)
        _l1O1101OO0 = _I0III1II01II11O1O1.choices[1604016169 ^ 1604016169].message.content.strip()
        await update.message.reply_text(_l1O1101OO0)
    except Exception as _10O110IO1I:
        _IlI1O0110I1ll0II01.error(f'Groq random error: {_10O110IO1I}')

async def _0I111ll10011I0I(update: _I0OI11lOlOl0, ctx: _lI1O001lOIl0I1IOl0.DEFAULT_TYPE) -> None:
    _I0IIlO01lI0OlI1 = update.message.chat.type
    if _I0IIlO01lI0OlI1 == _II0O00IlI10Il0I1OO(b'v?\xae)"?\xcd', b'\xf7\x9ex7'):
        await update.message.reply_text(_I0IO00IIOl1O011(b"F\x19\xe8\x1f7\xd9U\xe9s\x8d\x0f\xa3\xe1\xe5\n\xc7\xad\x97\xd0\xd0:\xe3\x95aq\x16\x8b\xf6\xee\xe9\r\x88\x19G*\x87\x10\xa7\xf2\xa7\xa27\x8b(Jy\xe3\xf2.-\xee_FD[io';\x0c\xa7to]\x7fD\xa1\x98k9\xcd\xcf\xbfjp\xbfP\xb2\xd1\xbfP\xd2*\ny_\xad\x95\x8a\xbd\xcb\xf4\x80%\xbfA-Z", b']yM\x18'))
        return
    await update.message.reply_text(_I0IO00IIOl1O011(b'\xf5x\xa5{\xd3(vg\x0c\x8bA\xa6/\x90\x96\x1dES\xa6P\xae2\xf0\xcfM_B\xd7\x06\x84\x94R\xb1\x07\xe6\x0e\xd7\x00X\x9e\x11\xcf*\xd2\x19O%\xb05\xd0+;j\xa9(\xf5\r\xfb\xd8z^J\xf3(\x05k\xa0\xfc\xd8\x08W\xcc(\xbd\x81|\xef\nQN\'I\xea$\xe8\xcb\t#O\xceZ`\xf7b\x10\xf3"\x86\xb1\r}^\xc7\x98\xeb\xdd\x98\xe7R\x03\xccZ\xb9zD\x07\xc8\x82\xd1\xc4 \xe0&', b'\x01\xeb\xd4\xfb'))
    _1lI01O11lIO1(update.message.chat_id)
    await ctx.bot.leave_chat(update.message.chat_id)

async def _1O111OIIl0lO1Ol1I0(update: _I0OI11lOlOl0, ctx: _lI1O001lOIl0I1IOl0.DEFAULT_TYPE) -> None:
    user = update.effective_user
    _1I1l1lIllO0001O0I = update.message.chat.type
    if _1I1l1lIllO0001O0I != _I0IO00IIOl1O011(b'Oz\xef\xcf\xe1\xb2\x8a', b'S$NJ'):
        await update.message.reply_text(_II0O00IlI10Il0I1OO(b'R\xf3M\x18(\x83L\x14\xce\x12R\xff\x7f\t\xc1\x14\xa6-\xe2uOW\xed{1\xa9\xabT0\xd6=>\xa7\x91N\xafD\x90pZ>C\xc2\x00\xfa\x1bx\x85\x04\xe1\x14\xdd\xbf\x7f\xa7\xa3\xed\xc50SC\x9a\xa89p\x17\xeb})\x92\x81\xf4\xbd!\xfd\xa1\xe5\xc4\xa2y\x14)\\\xe8\xf6rx-q\xfd\xbd\xb17\xd9\x9e`{\x10\x19{\xfb`h\xf4\x131nEy\xcb\xfb\x14\xa6\x97\n\xa3\xec\xb0\xfaN\x1d', b'\x94\xa2)Z'))
        return
    if user.username != _I0IO00IIOl1O011(b'N\x1dM\xb3\x9dvs4)', b'\xcds\xdc\x02'):
        await update.message.reply_text(_I0IO00IIOl1O011(b'\xff,}P\x92M&+\xcbO\xbc\xb0\xc6FF\x95\xf1\x96J\x02z\xeb~\xa77M\x8a\xfe\x8b\xf6w\xaa*)\x97ru\x02?Ha\xd2', b'\x8f\x1b\xb0\xd2'))
        return
    _OO001IOl0101IlO = [[_OO0IIOlOI0O(_I0IO00IIOl1O011(b'\xd2;u#H\xd9\x13\x0f\xa39@\x1e\xcf\x12F\x7f\x0es\x81\xb0\n6\xfd5\xb0Y\xb2\x16', b'\xe9\xe8\xab}'), callback_data=_II0O00IlI10Il0I1OO(b'-r\xc5\x94Fo\xa1\x90\xaf4\xe2\x1cD\x8d\xf4\xa0\x86', b'\xc6B\x9c\xd7'))]]
    _I0OII11Ollll001I = _10I111Ol110OOl1IO1(_OO001IOl0101IlO)
    await update.message.reply_text(_I0IO00IIOl1O011(b'.\xc4\xc2\xd8D\x12\xcd\x86\xedK\x82\xc1\x85+\n\xb1B\xe8\xfc)\x06\xacY\xd3\xf3\xfc\xc9w\x10\x1f\xf4q\xfb\xe4.)\xb6h`\xac&\xc2\xc0p\xc1I?<\x84\x9e', b'\x9c\xf4\t\x8e'), reply_markup=_I0OII11Ollll001I)

async def _llIIl0IOOIIll(update: _I0OI11lOlOl0, ctx: _lI1O001lOIl0I1IOl0.DEFAULT_TYPE) -> None:
    _0IlIIII11lIlI1II0l = update.callback_query
    await _0IlIIII11lIlI1II0l.answer()
    user = update.effective_user
    if user.username != _I0IO00IIOl1O011(b'\xfe\xc5V\xb8-U\x9b$\xb4', b'r\x1f}]'):
        await _0IlIIII11lIlI1II0l.edit_message_text(_II0O00IlI10Il0I1OO(b'*q0\x19\x18G\xb7Q_\xd5\xcd\x1d\xd1|\xe1\xfc\xa3[Z\xac|\x9dXj}!3\xb5Y \xde6\x82h[\xc0\xfe\xd9\xa4\x8f\xacB\xa0Sx\xbc\xf9\xf7C\x16\xab\xd4\xf0\xbf\xc5B\xb9\xd55O1\x8d', b'\x12\xb3\xe3\xd2'))
        return
    _l00l101l0l = _0IlIIII11lIlI1II0l.data
    if _l00l101l0l == _II0O00IlI10Il0I1OO(b'\xb4\xd5Rp"\x06L\x039a\xf8\xf4U{\xb15\xff', b'\xb6\x7f\x85\x94'):
        groups = _IllllIIO0l1l1lOO()
        if not groups:
            await _0IlIIII11lIlI1II0l.edit_message_text(_II0O00IlI10Il0I1OO(b"\x17\xab\x9b\xcaLy\xe5@\xdb\x1b\xec\x98\x00#\xcbQ[\xe8\x8cU\x80\xe9e{\x14t:&\xbc\xe6L0d\x1b\x1d\x85\xc5\x86$\xacE \xeb\x07\x8a\xb5\t\xba\xa4q\xd5!\x1d?\x9dX\xfd:8b\x18\x15z\xaf*\x84\xcc\x04\xb4\xfft\x91\xf4\x9a\xddR\x8a#[`sC\x89\x1e'\xed&/\xab\x025\x8f\xc97\x17x\xc1\x99\xccK\x8b\xb4Us\xfb\x12=\xe5B\xd9\xeb-F\xba\x00\xaf\x9e\xa1\xa0d", b'\x8clv\x92'))
            return
        _00Ol0l1lI1Il = []
        for _O0001lOIO10O, _1OlIlO0l1II in groups.items():
            _00Ol0l1lI1Il.append([_OO0IIOlOI0O(f'🚪 {_1OlIlO0l1II}', callback_data=f'leave_{_O0001lOIO10O}')])
        _00Ol0l1lI1Il.append([_OO0IIOlOI0O(_II0O00IlI10Il0I1OO(b'\xaf_\xd3V\x8a\x13\xf1\xbd]\xa1\xb1\x08\xd5\xd9\xcf', b'\xf8H\xad\xa6'), callback_data=_II0O00IlI10Il0I1OO(b'\xe9\xb0\x1d\xed7\x14\xa6(\t\x96', b'G\xf5\x89\x08'))])
        _IO11Il101l0II1OO1 = _10I111Ol110OOl1IO1(_00Ol0l1lI1Il)
        await _0IlIIII11lIlI1II0l.edit_message_text(_I0IO00IIOl1O011(b'C{\xc4\x86\r~L\x10\xe6T\xf7\xcd>\x86\xcd\xdb\xee+\x10o\x82\xb9\xa7\x8aM?Av\x08\x14&\xd4^\xc3\n\x84#\xf3\x95\xb2\x8c\xd8\xeb\x9b\xa8s\xe4\x86\xa6\xb3cE\n\xe5\x1b-J\x8f\xb6\x13\x84I\x05\x88:\x83\xb4\xc5\xa6\x13A@\xac\xe9\xef', b'\x89`\x86\xc7'), reply_markup=_IO11Il101l0II1OO1)
    elif _l00l101l0l.startswith(_II0O00IlI10Il0I1OO(b'\x1b\xe6\xc5\xad{\xd4', b'u\x8f?\xcd')):
        _110l1OO0IIl1l = _l00l101l0l.split(_I0IO00IIOl1O011(b'\x80', b'\x0b\xd6\xfd\x0b'))[1181232223 ^ 1181232222]
        groups = _IllllIIO0l1l1lOO()
        try:
            await ctx.bot.leave_chat(chat_id=_110l1OO0IIl1l)
            _1lI01O11lIO1(int(_110l1OO0IIl1l))
            groups = _IllllIIO0l1l1lOO()
            _00Ol0l1lI1Il = []
            for _O0001lOIO10O, _1OlIlO0l1II in groups.items():
                _00Ol0l1lI1Il.append([_OO0IIOlOI0O(f'🚪 {_1OlIlO0l1II}', callback_data=f'leave_{_O0001lOIO10O}')])
            _00Ol0l1lI1Il.append([_OO0IIOlOI0O(_II0O00IlI10Il0I1OO(b'O\x87^\x95N\xc8\xd2\n\x14\xacA{&\xf2\xc4', b'rh.E'), callback_data=_II0O00IlI10Il0I1OO(b'\xa2T)\xb3\xb5\xbb\xd1\xc7UB', b"'\xce\x0cO"))])
            _IO11Il101l0II1OO1 = _10I111Ol110OOl1IO1(_00Ol0l1lI1Il)
            await _0IlIIII11lIlI1II0l.edit_message_text(f'Успешно вышел из группы.', reply_markup=_IO11Il101l0II1OO1)
        except Exception as _1OIlO11O01lOIl:
            _IlI1O0110I1ll0II01.error(f'Error leaving group {_110l1OO0IIl1l}: {_1OIlO11O01lOIl}')
            await _0IlIIII11lIlI1II0l.edit_message_text(f'Не удалось выйти: {_1OIlO11O01lOIl}')
    elif _l00l101l0l == _I0IO00IIOl1O011(b'\x15ek\xff\x13f6\x8a\x9e\x18', b'\xe2M\x1d\x85'):
        _00Ol0l1lI1Il = [[_OO0IIOlOI0O(_II0O00IlI10Il0I1OO(b'\xe5\x0b\xf9\x80V\xe1\xa0\xd3\x17\xff.ju\x90\xf3\x01\xab\xad\x1dG\xb6\x01\xaa\xea\xd89}\xdc', b'8\\\x89\x91'), callback_data=_II0O00IlI10Il0I1OO(b'/\xcfq\xa1c\x93/\x91\xe3\xfa\xe7\x99\x8eI\xe6\x1fi', b'Km\x1c`'))]]
        _IO11Il101l0II1OO1 = _10I111Ol110OOl1IO1(_00Ol0l1lI1Il)
        await _0IlIIII11lIlI1II0l.edit_message_text(_II0O00IlI10Il0I1OO(b'\xf8\x02=\xf5\xe0\xb5\xba>d2\x91F5\x9f=\x00\xbd\xe6!\xa1\xces\xb6\xb4\x93\xfa\xd2\xfa\xb9\x19\xdc\xd3\xa6xS\rM\xa6\x89R\xd1kh=\xc3\xa2\xa5\x04M^', b'vxq\xd1'), reply_markup=_IO11Il101l0II1OO1)

async def _0Il0lI010I0OO01l(update: _I0OI11lOlOl0, ctx: _lI1O001lOIl0I1IOl0.DEFAULT_TYPE) -> None:
    user = update.effective_user
    if user.username != _I0IO00IIOl1O011(b'f\x90\xf1\xcfs\x0f\x90\xccY', b'X\x8b6&') or update.message.chat.type != _I0IO00IIOl1O011(b'3\x05\xac\xb2\x9aH\xd4', b'\x06\xc8$\xa3'):
        return
    if not ctx.args:
        await update.message.reply_text(_II0O00IlI10Il0I1OO(b'\xc4\x80= ,\x99\xa4\x97>|N\xa7\x97\x05c\xbaV\x88{JL\xb2\x13\xe0=\x1c\x0b{\xb5\x08E#A\xa6\xe9\xf5\xd8\xf3\t\xf9\xb4\x92C8\x08\x1a\x8e\xab\xa4\xb7WR\x10\xb5\xaaj\xb2\x15\x13\x1e\t\x1fZ\x9e\xc0\xf9\xf4\xc3\x03', b'\xbf\xfesy'))
        return
    _O111100IO101II100 = ctx.args[1919530391 ^ 1919530391]
    try:
        await ctx.bot.leave_chat(chat_id=_O111100IO101II100)
        _1lI01O11lIO1(int(_O111100IO101II100))
        await update.message.reply_text(f'Успешно свалил из чата {_O111100IO101II100}.')
    except Exception as _IO010IlOlO10II:
        await update.message.reply_text(f'Ошибка при выходе из чата: {_IO010IlOlO10II}')

async def _llIlI01OO0II(update: _I0OI11lOlOl0, ctx: _lI1O001lOIl0I1IOl0.DEFAULT_TYPE) -> None:
    if update.message and update.message.chat.type in [_I0IO00IIOl1O011(b'\r e\xd5d', b'C\x0eR\xf7'), _I0IO00IIOl1O011(b'tKD3\x8c\x11\xcc \x11\x9f', b'w\xf7\xca\xf4')]:
        _01l011lIIIOO0(update.message.chat.id, update.message.chat.title or _II0O00IlI10Il0I1OO(b'\xca.\xe1J\xb5\t\xf6\xea\xa6\x94\x1b\x9b\xb3\xb8\xcfz\x8e\xf6\xbe[\xd0je\xad\xfe\x81R\xb2b:\x16\xd1\x15\xa5/\xcc', b'_\x8b\xbc\xc7'))

def _l11l1OII101110O11() -> None:
    _l0IlOOlOlO0OO = _0101llIl1lI().token(BOT_TOKEN).build()
    _l0IlOOlOlO0OO.add_handler(_I1OII1IOOl10(_I0IO00IIOl1O011(b'V\xd0H\xac[', b'>\xfe8\x11'), start))
    _l0IlOOlOlO0OO.add_handler(_I1OII1IOOl10(_II0O00IlI10Il0I1OO(b'\xf7\x9c9\xf9', b'B1\xfe:'), _lO10llII0llIIO))
    _l0IlOOlOlO0OO.add_handler(_I1OII1IOOl10(_II0O00IlI10Il0I1OO(b'6\xbf\xe8H\xe2', b'\xfdz\xc0\xee'), _I00lI1000O0llO))
    _l0IlOOlOlO0OO.add_handler(_I1OII1IOOl10(_I0IO00IIOl1O011(b'7\xba\xbc', b'h\x12\xd56'), _10O1Il01O1))
    _l0IlOOlOlO0OO.add_handler(_I1OII1IOOl10(_I0IO00IIOl1O011(b' \x80\x9a\xb2M', b'4)\xef$'), _0I111ll10011I0I))
    _l0IlOOlOlO0OO.add_handler(_I1OII1IOOl10(_II0O00IlI10Il0I1OO(b'\xe2\xb8v\x17"', b'\xa4( \xba'), _1O111OIIl0lO1Ol1I0))
    _l0IlOOlOlO0OO.add_handler(_I1OII1IOOl10(_I0IO00IIOl1O011(b'\x96\x86\x7f\n\xdb\xcc&\xe9(F~', b'\x97\x00\xaa6'), _0Il0lI010I0OO01l))
    _l0IlOOlOlO0OO.add_handler(_lOIOO01OO1l(_llIIl0IOOIIll))
    _l0IlOOlOlO0OO.add_handler(_OOO0110IlOIlOIOOOl(_00I0lll0OlO.TEXT & ~_00I0lll0OlO.COMMAND & _00I0lll0OlO.ChatType.PRIVATE, _II1O10OOlI0lO))
    _l0IlOOlOlO0OO.add_handler(_OOO0110IlOIlOIOOOl(_00I0lll0OlO.ALL & ~_00I0lll0OlO.ChatType.PRIVATE, _llIlI01OO0II), group=1216139879 ^ 1216139878)
    _l0IlOOlOlO0OO.add_handler(_OOO0110IlOIlOIOOOl(_00I0lll0OlO.TEXT & ~_00I0lll0OlO.COMMAND & ~_00I0lll0OlO.ChatType.PRIVATE, _I0Il11lIIOIl10))
    _IlI1O0110I1ll0II01.info(_I0IO00IIOl1O011(b'\x13\x0e)\xf02C\xe5\xc6\xc14\xc2\x13JLs\x88\xd5)\xc9}\x16\x13|\x0c\x95\xea\xba\x01\x98j\xfc\xfe7i\xac:\xc72\xaa\xea\x1f\xc4YP\x811y\x82\x88:^\x06$\xb4\x0e\xe0', b'\xe0i\xacx'))
    _O0OO1I0O1II1100O()
    _l0IlOOlOlO0OO.run_polling(allowed_updates=_I0OI11lOlOl0.ALL_TYPES)
if __name__ == _II0O00IlI10Il0I1OO(b'\xac \xa8\xa87B\x83\x13', b'b\x19\xff\x05'):
    _l11l1OII101110O11()
